...
namespace LabAiMinFunConsole.View
{
    class EvolutionCreator
    {
        ...
        public void StartEvolution()
        {
            ...
            IOrderedEnumerable<Father> fathersSorted;
            
           
            while (true)
            {
                fathersSorted = from father in fathers
                                orderby father.CoordinatesValue
                                select father;
                /*
                ...
                */
                List<Child> children = GetChildren(fathersSorted.ToList());
